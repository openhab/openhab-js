...
Note that `event` object is only available when the UI based rule was triggered by an event and is not called from another rule unless it is passed from the calling rul!
...
| `event`        | string                                                                                                               | channel based triggeres                | Event data publsihed by the triggering channel.                                                               | `receivedEvent`        |
