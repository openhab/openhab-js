...
| Bugfix      | `rules`    | `_getTriggeredData()`: Provide a merge function when collapsing input map        | [#529](https://github.com/openhab/openhab-js/pull/529) | No       |
| Bugfix      | `rules`    | `_getTriggeredData()`: Fix NPE & Convert input to JS object before collapsing it | [#531](https://github.com/openhab/openhab-js/pull/531) | No       |
